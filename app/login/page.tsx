    ...
    <div className="animate-in flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2">
      {view === "check-email" ? (
        ...
        >
          ...
          {view === "sign-in" && (
            <>
              <button className="flex items-center bg-gray-700 rounded px-4 py-2 text-white mb-6">
                <div>
                  <span className="wiggle-in text-2xl mr-16">🍒</span>
                </div>
                <div>Sign In with Email verification</div>
              </button>
              <button
                onClick={handleGoogleSignIn}
                className="flex  items-center bg-gray-700 rounded px-4 py-2 text-white mb-6"
              >
                <div className="mr-16">
                  <svg
